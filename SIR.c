...
int main(){
    ...
    double R_list[15]={5.0,7.0,8.0,9.0,10.0,15.0,20.0,30.0,40.0,50.0,60.0,70.0,80.0,90.0,100.0};//5.0,7.0,8.0,9.0,10.0,15.0,20.0,30.0,40.0,50.0,60.0,70.0,80.0,90.0,100.0
    ...
    for(q=0;q<Q;q++){
        for(h=0;h<Rsize;h++){ 
            ...
            printf("でたよー");    
                ...
                fprintf(gp,"set output 'SIRbef_%.3f.png'\n",c);
                ...
                /*メインの平衡状態を作る*/
                printf("OK\n");
                y2[h]=infection(con,con_a,con_b,P_list,F_list,c,R_list[h],0,0,x,y1,S,I,R,O,1);

                data_file3="SIRafter.dat";
