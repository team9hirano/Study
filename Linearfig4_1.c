...
int main(){
    ...
    for(q=0;q<Q;q++){
        for(h=0;h<Rsize;h++){ 
            ...
            def=infection(con,con_a,con_b,P_list,F_list,c,R_list[h],0,0,x,y1,S,I,O,0);
            ...
            printf("でたよー");    
                ...
                fprintf(gp,"set output 'Linearbef_%.3f.png'\n",c);
                ...
                y2[h]=infection(con,con_a,con_b,P_list,F_list,c,R_list[h],0,0,x,y1,S,I,O,1);

                data_file3="Linearafter.dat";
                ...
                fprintf(gp,"set output 'Linearafter_%.3f.png'\n",r);
