...
int main(){
    ...
    double R_list[15]={3.0,4.0,5.0,7.0,9.0,10.0,13.0,17.0,20.0,30.0,40.0,50.0,60.0,80.0,100.0};
    ...
    for(q=0;q<Q;q++){
        for(h=0;h<Rsize;h++){ 
            ...
            printf("でたよー");    
                ...
                fprintf(gp,"set output 'Globalbef.png'\n");
                ...
                fprintf(gp,"set output 'Globalafter.png'\n");
    ...
    //図の描画
        ...
        fprintf(gp,"set output 'Global.png'\n");
...
double infection(int con[][N],double con_a[][N],double con_b[][N],double P_list[],double F_list[],double r,int P_size,int f_size,int x[],double y[],int S[],int I[],int O[],int g){
    ...
    data_file1="Global_beta.dat";
        ...
        // fprintf(gp,"set logscale\n");
        // fprintf(gp,"set output 'Addefunction_f_%2f_P_%2f.png'\n",F_list[0],P_list[0]);
        fprintf(gp,"set output 'Global_beta.png'\n");
